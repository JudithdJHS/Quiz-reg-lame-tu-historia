    ...
    <main className="flex flex-col md:flex-row w-full min-h-screen md:h-screen">
      ...
      <div className="hidden md:flex md:w-1/2 h-full bg-[#3D3520] flex-col items-center justify-center gap-4">
        ...
        <div style={{ textAlign: 'center', padding: '0 24px' }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.75rem', color: 'rgba(253,250,246,0.4)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Video próximamente
          </p>
        </div>
      </div>
        ...
        >
          <div style={{ maxWidth: '380px', width: '100%' }}>
            ...
            <motion.p
              ...
              style={{ fontFamily: 'Inter, sans-serif', fontSize: '18px', color: '#3D3520', lineHeight: '1.8', marginBottom: '18px', textAlign: 'center' }}
            >
            ...
            >
              <Link
                ...
                style={{ fontFamily: 'Inter, sans-serif', backgroundColor: '#6B783E', color: '#FDFAF6', padding: '16px 0', borderRadius: '10px', boxShadow: '0 6px 24px rgba(107,120,62,0.28)', letterSpacing: '0.01em' }}
              >
                Comenzar mi camino →
              </Link>
            </motion.div>
            ...
            <motion.p
              ...
              style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.75rem', color: '#BD886A', marginTop: '28px', textAlign: 'center', letterSpacing: '0.03em' }}
            >
